...
class DesignTokens extends ThemeExtension<DesignTokens> {
  ...
  factory DesignTokens._lightGlass(
    ...
    bool blurEnabled = true,
      ...
      DesignTokens(
        ...
        cardBorder: const Color(0x12181820),
        insetBg: const Color(0x0D161626),
        hairline: const Color(0x17161626),
        chipBg: const Color(0x0D161626),
        chipBgActive: _tint(p.primaryDark, 0.14),
        sidebarBg: const Color(0x94EEEEF2),
  ...
  factory DesignTokens._lightClassic(ColorSchemePreset p) => DesignTokens(
        ...
        text2: const Color(0xFF6F6F78),
        text3: const Color(0xFF9C9CA4),
        bg: const Color(0xFFE9E8EC),
        bgStrong: const Color(0xFFF3F2F5),
        panelBg: const Color(0xFFFFFFFF),
        panelBgStrong: const Color(0xFFFFFFFF),
        panelBlurSigma: 0,
        panelBorder: const Color(0xFFE5E4E9),
        cardBg: const Color(0xFFFFFFFF),
        cardBgHover: const Color(0xFFF6F5F8),
        cardBorder: const Color(0xFFE9E8ED),
        insetBg: const Color(0xFFEFEEF2),
        hairline: const Color(0xFFE9E8ED),
        chipBg: const Color(0xFFEFEEF2),
        chipBgActive: _tint(p.primaryDark, 0.14),
        sidebarBg: const Color(0xFFE9E9EC),
        segOnBg: const Color(0xFFFFFFFF),
        accent: p.primary,
  ...
  static Color _tint(Color base, double alpha) =>
  ...
  DesignTokens lerp(ThemeExtension<DesignTokens>? other, double t) {
    ...
    return DesignTokens(
      ...
      panelBlurSigma: panelBlurSigma + (other.panelBlurSigma - panelBlurSigma) * t,
